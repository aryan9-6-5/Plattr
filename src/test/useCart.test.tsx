...
describe("useCart Hook", () => {
  ...
  it("should apply flat promo code", () => {
    ...
    // Subtotal(200) - Discount(50) = 150. Delivery for 150 is 40.
    // Total calculation: (150 + 40) * 1.05 = 199.5 -> rounds to something
    // The reducer logic: taxableAmount = subtotal - discount + deliveryFee
